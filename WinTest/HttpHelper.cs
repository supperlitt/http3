...
namespace WinTest
{
    ...
    public class HttpHelper
    {
        ...
        ///</summary>
        public Stream PostAndGetStream(string targetURL, string formData, string contentType, string referer, bool allowAutoRedirect, Encoding encoding2 = null, Dictionary<string, string> header = null)
        {
            byte[] data = null;
            if (encoding2 != null)
            {
        ...
        ///</summary>
        public string PostAndGetHtml(string targetURL, string formData, string contentType, string referer, bool allowAutoRedirect, Encoding encoding, Encoding encoding2 = null, Dictionary<string, string> header = null)
        {
            Stream stream = PostAndGetStream(targetURL, formData, contentType, referer, allowAutoRedirect, encoding2, header);
        ...
        ///</summary>
        public Stream GetAndGetStream(string targetURL, string contentType, string referer, bool allowAutoRedirect, Dictionary<string, string> header = null)
        {
            //请求目标网页
            HttpWebRequest request = null;
            if (targetURL.StartsWith("https", StringComparison.OrdinalIgnoreCase))
        ...
        ///</summary>
        public string GetAndGetHtml(string targetURL, string contentType, string referer, bool allowAutoRedirect, Encoding encoding, Dictionary<string, string> header = null)
        {
            Stream stream = GetAndGetStream(targetURL, contentType, referer, allowAutoRedirect, header);
            string html = new StreamReader(stream, encoding).ReadToEnd();
            return html;
        }
        ...
        private static string UserAgent()
        {
            ...
            list.Add("Mozilla/5.0 (compatible; MSIE 7.0; Windows NT 6.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; .NET4.0C; .NET4.0E)");
            list.Add("Mozilla/5.0 (compatible; MSIE 7.0; Windows NT 5.1; SV1; .NET CLR 2.0.1124)");
            list.Add("Mozilla/5.0 (compatible; MSIE 7.0; Windows NT 5.2; .NET CLR 1.1.4322; .NET CLR 2.0.50727)");
            list.Add("Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36");
